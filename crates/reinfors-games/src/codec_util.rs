...
//! typed `validate_decoded_state` plus decode-time recomputation of derived flags.
...
/// decoding is STRUCTURAL only — safety checks live in each game's `validate_decoded_state`.

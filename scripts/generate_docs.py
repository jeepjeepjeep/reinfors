...
def games_page() -> str:
    ...
    return (
        ...
        + "at restore, which is what keeps hostile snapshot bytes safe. Restore is exact and "
        + "always resumes the same trajectory, but that trajectory departs from a "
        + "never-snapshotted run at float rounding order (solver bookkeeping is rebuilt, "
        + "not restored).\n"

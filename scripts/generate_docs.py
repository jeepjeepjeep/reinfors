...
def games_page() -> str:
    ...
    return (
        ...
        + "- Search-based algorithms (TreeStrap, AlphaZero) are mechanically supported: after "
        + "the track is realized the game is a deterministic single-agent planning problem. "
        + "Under the pixels encoder every search node renders a full frame, so search-based "
        + "training is far more economical with `rf.encoders.CarRacingVec()`.\n"

...
MCCFR) over 2-10-player sequential games with declared chance and information-state keys — the
poker family. Query the result with ``average_strategy(env.information_state_key(agent))``;
measure convergence with exact metrics on small trees such as Kuhn and Leduc.
"""

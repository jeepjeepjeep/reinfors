...
class LearnerHandle:
    ...
    # per own decision, the DQN convention. Collection is windowed: complete rounds under
    # frozen weights to the record floor, with unfinished trajectories bootstrapped and
    # emitted at the boundary. Data is on-policy: collect, update, discard.
    @staticmethod
